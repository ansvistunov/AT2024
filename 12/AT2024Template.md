...
| СКИП           | Система контроля исполения поручений |
...
- **Ограничения памяти**: Компьютер пользователя должен иметь досточно оперативной памяти и дискового пространства для стабильной работы браузрера.
- **Действия**: Назначение, отслеживание, выполнение поручений, одобрение выполненых поручений. Установка срока поручения при назначении, перенаправление поручений к содрудникам ниже по иерархии.

## Функции изделия
- Назаначение поручений сотруднику ниже по иерархии с датой выполнения задачи.
- Просмотр полученных и отпраленных поручений.
...
- Сотрудники предприятия — любые работники предприятия, как с подчинёнными сотруниками, так и без.
