...
#### 3.2.1 Вход сотрудника
Система должна поддерживать аутентификацию сотрудников с использованием логина и пароля.
#### 3.2.2 Вход администратора
Система должна поддерживать аутентификацию администратора с использованием логина и пароля.
### 3.3 Возможности администратора
Администратору должно быть доступно создание, редактирование и удаление учётной записи сотрудника.
### 3.4. Создание поручений
