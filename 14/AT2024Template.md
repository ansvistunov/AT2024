...
1. Сбор и обработка данных с датчиков
    ...
    2. Данные должны поступать в систему с заранее определённой частотой для поддержания актуальности информации.
...
2. Оповещение о критических состояниях
    ...
    2. Уведомления должны отправляться по электронным почте или другим каналам, настроенным в системе.

3. Отчёты о работе оборудования
    1. Система должна генерировать отчёты по итогам работы оборудования за определённый период.
    2. Отчёты должны включать информацию о переходах в аварийные режимы и времени работы в каждом режиме.

4. Настройка пороговых значений
    1. Система должна позволять пользователю задавать пороговые значения для каждого датчика.
    2. Пороговые значения можно редактировать в зависимости от особенностей эксплуатации оборудования.
...
5. Поддержка структуры узлов
    ...
    2. При аварии одного из элементов узла система переводит весь узел в аварийный режим.

6. Визуализация текущего состояния
    1. Система должна показывать текущее состояние оборудования на панели управления.
    2. На панели должны отображаться основные параметры и статус (нормальный, критический, аварийный).

7. Резервное копирование данных
    1. Система должна автоматически создавать резервные копии данных с датчиков на регулярной основе.
    2. Резервные копии должны храниться на отдельном сервере или в облачном хранилище для обеспечения безопасности данных.
...
8. Мониторинг состояния сервера
    ...
    2. В случае обнаружения критических значений (например, высокая нагрузка на процессор, низкий уровень свободного места на диске), система должна отправлять оповещения администраторам.
...
9. Автоматическое восстановление после сбоев
    ...
    2. В случае сбоя, система должна восстановить последнее сохраненное состояние и продолжить сбор данных без потери информации.
...
10. Масштабируемость системы
    ...
    2. Добавление новых датчиков или узлов не должно требовать значительных изменений в архитектуре системы.
...
11. Логирование событий
    ...
    2. Логи должны быть доступны для анализа и аудита.
...
12. Интерфейс для интеграции с другими системами
    ...
    2. Интеграция должна обеспечивать двустороннюю передачу данных и команд.
...
13. Аналитика и прогнозирование
    ...
    2. Прогнозирование должно основываться на исторических данных и алгоритмах машинного обучения.

14. Управление доступом
    1. Система должна поддерживать разграничение доступа для разных пользователей и групп пользователей.
    2. Пользователи должны иметь доступ только к тем функциям и данным, которые соответствуют их ролям и правам.
