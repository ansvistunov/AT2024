...
## Краткий обзор
   1 - Введение - описывает цели документа, его границы применения, термины и аббревиатуры
   2 - Общее описание - описывает изделие, его верхнеуровневые функции и его ограничения. Также описывает характеристики пользователей.
   3 - Детальные требования - описывает функциональные требования, характеристики ремонтопригодности, надежности, производительности, тербования к пользовательской документации.
---
