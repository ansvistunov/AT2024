...
# 1. Введение
Этот документ определяет спецификацию требований к программному обеспечению (СТПО) для Системы электронного документооборота (СЭД), предназначенной для повышения прозрачности в организации. В этом документе излагаются как функциональные, так и нефункциональные требования к СЭД, включая область применения системы, конструктивные ограничения и спецификации интерфейса.
