...
| **Источник**         | Ссылается на исходные данные или документ, откуда требование было получено.                                                                                           |
...
| **Ссылки**           | Ссылается на связанные с требованием документы или случаи использования.                                                                                            |

#### 3.1.1 Основные функции

##### 3.1.1.1 Пользователи и роли пользователей

**ID требования**: FR1.01.01  
**Название**: Поддержка пользователей  
**Описание**: Система должна поддерживать концепцию пользователей. Каждый пользователь системы должен иметь уникальное имя пользователя и пароль. Помимо этого, у каждого пользователя должен быть следующий набор атрибутов: Полное имя, Должность (компания, позиция), Email, Рабочий телефон, Альтернативный телефон, Альтернативный рабочий адрес. Каждый пользователь должен быть однозначно идентифицирован в системе.  
**Приоритет**: 1  
**Риски**: Низкий  
**Источник**: Анализ требований  

**ID требования**: FR1.01.02  
**Группа**: Пользователи и роли пользователей  
**Название**: Поддержка ролей пользователей  
**Описание**: Система должна поддерживать концепцию ролей пользователей. Каждая роль должна иметь уникальное имя в системе и набор разрешений, определяющих доступ пользователя к различным функциональным возможностям системы. Один пользователь может быть связан с несколькими ролями, однако роли с ограничением доступа имеют приоритет над разрешающими. Система должна реализовать контроль доступа на основе ролей (RBAC).  
**Приоритет**: 1  
**Риски**: Низкий  

**ID требования**: FR1.01.03  
**Группа**: Пользователи и роли пользователей  
**Название**: Управление ролями пользователей  
**Описание**: Система должна позволять пользователю с правами администратора управлять ролями и разрешениями пользователей, включая создание, редактирование и удаление ролей.  
**Приоритет**: 1  
**Риски**: Средний   

##### 3.1.1.2 Основные действия пользователей

**ID требования**: FR1.02.01  
**Группа**: Основные функции  
**Название**: Загрузка документа  
**Описание**: Система должна позволять пользователю с правами инициатора загружать документ для последующего согласования. Документ должен быть загружен в формате PDF, DOCX или других совместимых форматах. Система должна поддерживать версионность документов.  
**Приоритет**: 1  
**Риски**: Низкий  
**Источник**: Пользовательские сценарии  

**ID требования**: FR1.02.02  
**Группа**: Основные функции  
**Название**: Настройка маршрута согласования  
**Описание**: Пользователь-инициатор должен иметь возможность настраивать последовательность шагов для согласования документа (маршрут согласования). Маршрут может быть изменён на любом этапе согласования по решению инициатора.  
**Приоритет**: 1  
**Риски**: Средний  

**ID требования**: FR1.02.03  
**Группа**: Основные функции  
**Название**: Отправка уведомлений  
**Описание**: Система должна автоматически отправлять уведомления по электронной почте всем участникам согласования, включая информацию о необходимости подписания или изменения документа. Уведомления должны также отображаться в веб-интерфейсе системы.  
**Приоритет**: 1  
**Риски**: Низкий   
...
**ID требования**: FR1.04.01  
**Группа**: Основные функции  
**Название**: Хранение документов  
**Описание**: Система должна хранить все загруженные документы и их версии в защищённом хранилище. Документы должны быть доступны для просмотра и редактирования в зависимости от прав доступа пользователя.  
**Приоритет**: 1  
**Риски**: Средний  

**ID требования**: FR1.04.02  
**Группа**: Основные функции  
**Название**: Архивация документов  
**Описание**: Система должна поддерживать архивирование документов. Архивированные документы должны сохраняться в системе, но не должны быть доступны для редактирования.  
**Приоритет**: 2  
**Риски**: Низкий  
