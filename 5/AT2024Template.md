...
- интерфейс просмотра количества бонусных баллов;
- интерфейс просмотра каталога товаров и соответствующего количества баллов, начисляемых за него или необходимых для списания за его покупку.
...
- интерфейс работы с базой данных клиентов и их бонусных баллов;
- интерфейс расчета бонусных баллов по определенной системе;
...
- интерфейс обмена данными с сервером программы лояльности для синхронизации информации о бонусных баллах.
### 2.1.6 Ограничения памяти
Есть необходимость хранить следующие данные:
- информация о клиентах, их картах и бонусных баллах;
- информация о транзакциях: начислениях и списаниях баллов;
- информацию каталога: информацию о товарах, начисляемых за них бонусных баллах, необходимом количестве бонусных баллов для их покупке и т.д.
...
- покупатели;
- администраторы - те, кто имеют доступ к каталогу и имеют возможность изменения списка товаров и перераспределения количества юонусных баллов между товарими.
...
- исходный каталог товаров и правила начисления и списания бонусных баллов могут быть изменены администрацией магазина без предварительного уведомления.
